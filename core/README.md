...
*   [add-route input](./add-route-input.md "Route traffic to the given network through a VPN node") – `http://schema.nethserver.org/cluster/add-route-input.json`
...
*   [push-route output](./push-route-output.md "Just a boolean value") – `http://schema.nethserver.org/cluster/push-route-output.json`
...
*   [remove-route input](./remove-route-input.md "Remove the route for the given network through the VPN node") – `http://schema.nethserver.org/cluster/remove-route-input.json`
